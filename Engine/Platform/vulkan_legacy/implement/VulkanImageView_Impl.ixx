...
namespace FOCUS
{
    ...
    {
        VkCommandBuffer commandBuffer = vkCommandBuffer->beginSingleTimeCommands(device);
        ...
        vkCommandBuffer->endSingleTimeCommands(commandBuffer, graphicsQueue, device);
    }

    void VulkanImageView::copyBufferToImage
    (
        VkBuffer buffer, 
        VkImage image, 
        uint32_t width, 
    ...
    void VulkanImageView::createTextureImageView(VkDevice device) 
    {
    ...
    )
    {
        ...
        transitionImageLayout(textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_LAYOUT_UNDEFINED, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, vkCommandBuffer, device, graphicsQueue);
        copyBufferToImage(stagingBuffer, textureImage, static_cast<uint32_t>(texWidth), static_cast<uint32_t>(texHeight), vkCommandBuffer, device, graphicsQueue);
        transitionImageLayout(textureImage, VK_FORMAT_R8G8B8A8_SRGB, VK_IMAGE_LAYOUT_TRANSFER_DST_OPTIMAL, VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL, vkCommandBuffer, device, graphicsQueue);
