...
namespace drhi
{
	...
	public:
		...
		virtual void draw(DynamicCommandBuffer* commandBuffer, uint32_t vertexCount, uint32_t instanceCount, uint32_t firstVertex, uint32_t firstInstance);
		...
		virtual void beginRendering(DynamicCommandBuffer commandBuffer, DynamicRenderingMRTInfo* bri);
		...
		virtual void endRendering(DynamicCommandBuffer commandBuffer, DynamicRenderingMRTInfo* bri);
		...
		virtual void getViewportImageCreateInfo(VkImageCreateInfo& imageCI);
		...
		virtual void getDepthImageCreateInfo(VkImageCreateInfo& imageCI);
