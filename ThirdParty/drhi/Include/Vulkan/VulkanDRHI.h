...
namespace DRHI
{
	...
	public:
		...
		virtual void setImageLayout(DynamicCommandBuffer* cmdBuf, DynamicImage* image, uint32_t aspectMask, uint32_t oldImageLayout, uint32_t newImageLayout, uint32_t srcStageMask, uint32_t dstStageMask);
