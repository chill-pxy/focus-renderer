...
namespace drhi
{
	...
	public:
		...
		virtual void draw(DynamicCommandBuffer* commandBuffer, uint32_t vertexCount, uint32_t instanceCount, uint32_t firstVertex, uint32_t firstInstance) = 0;
		...
		virtual void beginRendering(DynamicCommandBuffer commandBuffer, DynamicRenderingMRTInfo* bri) = 0;
		...
		virtual void endRendering(DynamicCommandBuffer commandBuffer, DynamicRenderingMRTInfo* bri) = 0;
		...
		virtual void executeCommands(drhi::DynamicCommandBuffer primaryCommandBuffer, std::vector<drhi::DynamicCommandBuffer> executeCommandbuffers) = 0;
		...
		virtual void getViewportImageCreateInfo(VkImageCreateInfo& imageCI) = 0;
		...
		virtual void getDepthImageCreateInfo(VkImageCreateInfo& imageCI) = 0;
