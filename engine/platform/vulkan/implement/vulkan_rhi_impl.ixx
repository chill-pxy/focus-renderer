...
namespace FOCUS
{
    ...
    void VulkanRHI::createSurface(GLFWwindow* window)
    {
    ...
    {
        auto vertShaderCode = readFile("C:/project/FOCUS/engine/asset/shader/b.spv");
        auto fragShaderCode = readFile("C:/project/FOCUS/engine/asset/shader/a.spv");
    ...
    bool VulkanRHI::checkDeviceExtensionSupport(VkPhysicalDevice device)
    {
        ...
        for (const auto& extension : availableExtensions) {
            requiredExtensions.erase(std::remove(requiredExtensions.begin(), requiredExtensions.end(), extension.extensionName), requiredExtensions.end());
        }
